...
fragmented. AI---including LLMs and retrieval-augmented systems---can unify
information flow. We introduce a modular framework that supports all encounter
phases and enables multidisciplinary collaboration.
...
\section{References}
% Use your preferred BibTeX database and style (e.g., AMA-like numeric).
% Example:
% \begin{thebibliography}{9}
% \bibitem{ref1} Author AB, Author CD. Title. Journal. Year;Volume(Issue):Pages.
% \end{thebibliography}
